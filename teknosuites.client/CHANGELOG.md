...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest teknosuites.client -- --template=react  --no-rolldown --no-immediate`.
...
- Crear archivo de proyecto (`teknosuites.client.esproj`).
